  ...
  <div>
    ...
    <section id="home" class="flex flex-col-reverse md:flex-row justify-center items-center xl:space-x-44 lg:space-x-24 sm:space-x-8 xl:p-12  mx-auto">
      <div class="flex-1 flex flex-col space-y-4">
        ...
        <!-- See my resume -->
        <!-- <a href="" target="_blank" class="text-xs lg:text-base bg-transparent w-full 2xl:w-1/3 hover:bg-turquoise font-semibold uppercase text-center hover:text-white dark:text-gray-400 dark:hover:text-white py-2 px-8 border border-turquoise hover:border-transparent rounded">
          {{$t('seeResume')}}
        </a> -->
      ...
      <div class="flex-1">
        <img class="2xl:w-5/6 w-full slit-in-diagonal-1 rounded-lg" src="../assets/images/hulya.jpeg" alt="Hülya Çavuş"/>
      </div>
    </section>
