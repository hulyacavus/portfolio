      ...
      <div class="bg-white shadow-xl rounded grid grid-rows-2 lg:grid-rows-1 lg:grid-cols-3">
        ...
        <div class="row-span-1 col-span-1 space-y-4 pt-20 bg-gradient-to-b from-green-100 to-blue-100 dark:from-gray-200 dark:to-gray-400">
          ...
          <div class="flex flex-col justify-start items-center pb-8">
            <div>
              <img class="inline-block w-52 h-52 xl:h-64 xl:w-64 rounded-full ring-2 ring-white object-cover mb-4" src="../assets/images/hulya.jpeg" alt="Hülya Çavuş">
            </div>
            <div>
          ...
          <div class="flex flex-col justify-start items-start pl-8 md:pl-2 xl:pl-12 space-y-4">
            ...
            <div class="flex justify-around items-center space-x-4">
              ...
              <div><h4 class="text-sm lg:text-base text-gray-700 lg:leading-loose leading-relaxed tracking-relaxed">hulyaalmory@gmail.com</h4></div>
            </div>
            <!-- <div class="flex justify-around items-center space-x-4">
          ...
          <div class="flex flex-col justify-start items-start pl-8 md:pl-2 xl:pl-12 pt-8 space-y-4">
            ...
            <div class="flex justify-around items-center space-x-4">
              ...
              <div><a href="https://twitter.com/Hulyacavuss99" target="_blank" class="text-sm lg:text-base hover:text-turquoise text-gray-700 lg:leading-loose leading-relaxed tracking-relaxed">Twitter</a></div>
            </div>
            <div class="flex justify-around items-center space-x-4">
              <div><i class="fab fa-linkedin text-lg"></i></div>
              <div><a href="https://www.linkedin.com/in/hülyaçavuş/" target="_blank" class="text-sm lg:text-base hover:text-turquoise text-gray-700 lg:leading-loose leading-relaxed tracking-relaxed">LinkedIn</a></div>
            </div>
            <div class="flex justify-around items-center space-x-4">
              <div><i class="fab fa-github text-lg"></i></div>
              <div><a href="https://github.com/hulyacavus" target="_blank" class="text-sm lg:text-base hover:text-turquoise text-gray-700 lg:leading-loose leading-relaxed tracking-relaxed">Github</a></div>
            </div>
          </div>
          ...
          <div class="space-y-4 mt-8">
            ...
            <div class="relative pt-8">
              <div class="flex justify-start space-x-12 mb-4 items-center">
                ...
                <div class="flex-1">
                  <h2 class="text-gray-800 text-sm lg:text-base mb-2 dark:text-gray-300">HTML</h2>
                ...
                <div class="flex-1">
                  <h2 class="text-gray-800 text-sm lg:text-base mb-2 dark:text-gray-300">CSS</h2>
                  <div class="overflow-hidden h-2 mb-4 text-xs  flex space-x-44 rounded bg-gray-200">
                    <div style="width:95%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-turquoise"></div>
                  </div>
                </div>
...
export default {
  ...
  data(){
    return{
      experiences:[
        {name: 'Web Designer and Translator', date: '2020-Present', company: 'Syscape'},
      ],
      formations:[
        {name: 'Selcuk University', date: '2020-2025', school: 'Bachelor in Translation and Interpretation'},
      ],
      languages:[
