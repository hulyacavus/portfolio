      ...
      <div class="relative" v-on-clickaway="hide">
        ...
        <div class="fixed flex flex-col right-20 bottom-14 w-80 shadow-xl" v-show="visible">
            <div class="flex items-center px-4 rounded-t-lg py-5 bg-gray-500 dark:bg-gray-700">
                <div>
                    <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white object-cover" src="../assets/images/hulya.jpeg" alt="Hülya Çavuş">
                </div>
            ...
            if(this.questions[question] == 'Based'){
                setTimeout(() => {
                    this.chat.innerHTML += '<div class="flex flex-col items-start">'+
                        '<img v-img class="h-52 w-52" src="https://images.unsplash.com/photo-1623613229313-5e59f698526f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="Istanbul"></div>'
                }, 2000);
